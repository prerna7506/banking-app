...
export const userResolvers = {
  Query: {
    ...
    // Updated user query to use authenticated user from token
  ...
  Mutation: {
    ...
    updateUser: async (_, { id, input }, { user }) => {
      ...
      if (user.userId !== id)
        throw new Error(
          "Unauthorized access.. You can only update your own profile"
        );
      ...
      try {
        ...
        throw new Error("Failed to update details: " + err.message);
      }
    },
    ...
    deleteUser: async (_, { id }, { user }) => {
      ...
      if (user.userId !== id)
        throw new Error(
          "Unauthorized access.. You can only delete your own profile"
        );
